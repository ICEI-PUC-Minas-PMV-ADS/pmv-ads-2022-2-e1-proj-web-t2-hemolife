...
| Passos                | Acessar a sessão de login na aba de navegação em qualquer uma das páginas disponíveis ![Login - Hemo Life](https://icei-puc-minas-pmv-ads.github.io/pmv-ads-2022-2-e1-proj-web-t2-hemolife/src/pages/login.html) visualizar ou clicar na funcinalidade pretendida. |
