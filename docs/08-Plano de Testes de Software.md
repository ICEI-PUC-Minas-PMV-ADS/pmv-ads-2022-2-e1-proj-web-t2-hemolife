...
| Passos                | Acessar a sessão de login na aba de navegação em qualquer uma das páginas disponíveis <a href="https://icei-puc-minas-pmv-ads.github.io/pmv-ads-2022-2-e1-proj-web-t2-hemolife/src/pages/login.html">Sessão de login</a> 
visualizar ou clicar na funcinalidade pretendida. |
